...
export const BUSINESS_BACKUP_SHEETS: readonly BusinessBackupSheet[] = Object.freeze([
  stored("business_table_1", "表1_教师信息", 1, Object.freeze([
    ...
    key("person_campus_assignment_change_effect", "weekly_fee_entry_id", "归属纠正批次与周费用共同定位迁移影响"),
    ...
    key("admin_planning_mentor_relationship_change_preview", "id", "管理员规划导师关系变更预览主键"),
    key("admin_planning_mentor_relationship_change", "id", "管理员规划导师关系变更发布批次主键"),
    key("admin_planning_mentor_relationship_change_effect", "change_id", "管理员规划导师批次与周费用共同定位迁移影响"),
    key("admin_planning_mentor_relationship_change_effect", "weekly_fee_entry_id", "管理员规划导师批次与周费用共同定位迁移影响"),
    ...
    source("person_campus_assignment_change_preview", "person_id", "被调整人员", "关联 person.id"),
    source("person_campus_assignment_change_preview", "target_campus_id", "目标校区", "关联 organization_unit.id"),
    source("person_campus_assignment_change_preview", "target_region_id", "目标大区", "关联 organization_unit.id"),
    source("person_campus_assignment_change_preview", "target_principal_person_id", "目标校长", "关联 person.id"),
    source("person_campus_assignment_change_preview", "impact_json", "冻结归属影响", "严格白名单转换的归属与费用影响事实"),
    source("person_campus_assignment_change", "assignment_version", "归属版本", "同一人员归属纠正版本"),
    source("person_campus_assignment_change", "idempotency_key_fingerprint", "请求幂等指纹", "仅导出不可逆指纹"),
    source("person_campus_assignment_change", "before_json", "归属纠正前快照", "严格白名单转换的发布前归属事实"),
    source("person_campus_assignment_change", "after_json", "归属纠正后快照", "严格白名单转换的发布后归属事实"),
    source("person_campus_assignment_change_effect", "change_id", "归属纠正批次", "关联人员校区归属纠正批次"),
    source("person_campus_assignment_change_effect", "weekly_fee_entry_id", "周费用", "受影响周费用"),
    source("person_campus_assignment_change_effect", "delta_json", "账户差额", "严格白名单转换的账户与分类差额事实"),
    ...
    source("person_relationship", "superseded_by_admin_planning_mentor_change_id", "管理员规划导师同周替代批次", "关联 admin_planning_mentor_relationship_change.id"),
    source("admin_planning_mentor_relationship_change_preview", "action", "管理员规划导师操作", "ADD/REPLACE/REMOVE 的已冻结预览操作"),
    source("admin_planning_mentor_relationship_change_preview", "mentor_person_id", "目标规划导师ID", "管理员操作目标导师"),
    source("admin_planning_mentor_relationship_change_preview", "planner_person_id", "规划师ID", "管理员操作目标规划师"),
    source("admin_planning_mentor_relationship_change_preview", "source_relationship_id", "原关系ID", "REPLACE/REMOVE 时关联原规划导师关系"),
    source("admin_planning_mentor_relationship_change_preview", "result_relationship_id", "结果关系ID", "ADD/REPLACE 时关联结果规划导师关系"),
    source("admin_planning_mentor_relationship_change_preview", "continuation_relationship_id", "续接关系ID", "可空；限定截止周后恢复原规划导师的续接关系"),
    source("admin_planning_mentor_relationship_change_preview", "effective_teaching_week_id", "生效教学周ID", "普通周关系边界"),
    source("admin_planning_mentor_relationship_change_preview", "effective_through_teaching_week_id", "生效截止教学周ID", "可空；指定时在截止周后恢复既有关系"),
    source("admin_planning_mentor_relationship_change_preview", "impact_json", "冻结预览影响", "严格白名单转换的费用和账户影响事实"),
    source("admin_planning_mentor_relationship_change_preview", "created_by_person_id", "预览创建人", "SYSTEM_OWNER 或 SYSTEM_ADMIN"),
    source("admin_planning_mentor_relationship_change", "preview_id", "预览ID", "唯一关联冻结预览"),
    source("admin_planning_mentor_relationship_change", "action", "管理员规划导师操作", "ADD/REPLACE/REMOVE 的已发布操作"),
    source("admin_planning_mentor_relationship_change", "mentor_person_id", "目标规划导师ID", "变更后的规划导师；REMOVE 时为原导师"),
    source("admin_planning_mentor_relationship_change", "planner_person_id", "规划师ID", "被调整的规划师"),
    source("admin_planning_mentor_relationship_change", "relationship_version", "关系版本", "同一规划师管理员关系变更版本"),
    source("admin_planning_mentor_relationship_change", "source_relationship_id", "原关系ID", "REPLACE/REMOVE 时原关系"),
    source("admin_planning_mentor_relationship_change", "result_relationship_id", "结果关系ID", "ADD/REPLACE 时结果关系"),
    source("admin_planning_mentor_relationship_change", "continuation_relationship_id", "续接关系ID", "可空；限定截止周后恢复原规划导师的续接关系"),
    source("admin_planning_mentor_relationship_change", "effective_teaching_week_id", "生效教学周ID", "普通周重算边界"),
    source("admin_planning_mentor_relationship_change", "effective_through_teaching_week_id", "生效截止教学周ID", "可空；指定时在截止周后恢复既有关系"),
    source("admin_planning_mentor_relationship_change", "idempotency_key_fingerprint", "请求幂等指纹", "只保留不可逆指纹"),
    source("admin_planning_mentor_relationship_change", "posting_status", "入账状态", "POSTED 或 NO_BALANCE_CHANGE"),
    source("admin_planning_mentor_relationship_change", "planner_delta_cents", "规划师差额分", "管理员变更冻结的规划师账户差额"),
    source("admin_planning_mentor_relationship_change", "source_mentor_delta_cents", "原导师差额分", "管理员变更冻结的原规划导师账户差额"),
    source("admin_planning_mentor_relationship_change", "destination_mentor_delta_cents", "目标导师差额分", "管理员变更冻结的目标规划导师账户差额"),
    source("admin_planning_mentor_relationship_change", "settlement_calculation_run_id", "分配运行ID", "重算运行事实"),
    source("admin_planning_mentor_relationship_change", "ledger_event_id", "账本事件ID", "差额账本事件"),
    source("admin_planning_mentor_relationship_change", "before_json", "原关系快照", "严格白名单转换的发布前关系事实"),
    source("admin_planning_mentor_relationship_change", "after_json", "结果关系快照", "严格白名单转换的发布后关系事实"),
    source("admin_planning_mentor_relationship_change", "published_by_person_id", "发布人", "SYSTEM_OWNER 或 SYSTEM_ADMIN"),
    source("admin_planning_mentor_relationship_change_effect", "previous_snapshot_id", "原分配快照ID", "冻结前快照"),
    source("admin_planning_mentor_relationship_change_effect", "result_snapshot_id", "新分配快照ID", "重算后快照"),
    source("admin_planning_mentor_relationship_change_effect", "planner_account_id", "规划师账户ID", "受影响规划师结算账户"),
    source("admin_planning_mentor_relationship_change_effect", "source_mentor_account_id", "原导师账户ID", "可空；原规划导师结算账户"),
    source("admin_planning_mentor_relationship_change_effect", "destination_mentor_account_id", "目标导师账户ID", "可空；目标规划导师结算账户"),
    source("admin_planning_mentor_relationship_change_effect", "planner_delta_cents", "规划师费用差额分", "该费用规划师账户差额"),
    source("admin_planning_mentor_relationship_change_effect", "source_mentor_delta_cents", "原导师费用差额分", "该费用原规划导师账户差额"),
    source("admin_planning_mentor_relationship_change_effect", "destination_mentor_delta_cents", "目标导师费用差额分", "该费用目标规划导师账户差额"),
    source("admin_planning_mentor_relationship_change_effect", "delta_json", "全量差额", "严格账户和分类差额事实"),
