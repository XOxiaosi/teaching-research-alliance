 ...
 */
export const FULL_BACKUP_BUSINESS_SCHEMA_VERSION = "full-backup-business-schema.v1";
...
export const BUSINESS_BACKUP_SHEETS: readonly BusinessBackupSheet[] = Object.freeze([
  ...
  stored("business_table_5", "表5_工资奖金", 5, Object.freeze([
    ...
    source("project_bonus_transfer", "project_name_version_id", "奖金项目名称版本", "关联 bonus_project_name_version.id"),
    source("bonus_project_name_version", "display_name", "项目名称", "bonus_project_name_version.project_no 关联项目1-10名称版本"),
    source("salary_benefit_reversal", "original_ledger_event_id", "工资或福利原账本事件", "关联原财务单据和唯一冲回事件"),
    source("ledger_entry", "amount_cents", "相关账本金额", "通过已存 ledger_event 关联，不计算工资或奖金余额"),
  ])),
