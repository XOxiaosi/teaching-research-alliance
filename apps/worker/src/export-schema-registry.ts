...
const TRANSFORM_COLUMNS = new Set([
  ...
  "person_responsibility_command.idempotency_key", "person_profile_change.idempotency_key", "person_relationship_change.idempotency_key", "planning_mentor_relationship_change.idempotency_key",
