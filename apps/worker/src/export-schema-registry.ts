...
// This is intentionally a fixed allow-list generated from migrations 0001–0040.
...
const TABLE_COLUMNS: Readonly<Record<string, readonly string[]>> = {
  ...
  person_campus_assignment: columns("id,person_id,campus_id,region_id,valid_from,valid_to,created_by,created_at,superseded_by_person_campus_change_id"),
