...
// This is intentionally a fixed allow-list generated from migrations 0001–0039.
...
const TABLE_COLUMNS: Readonly<Record<string, readonly string[]>> = {
  ...
  person_relationship: columns("id,teacher_id,relationship_type,related_person_id,valid_from,valid_to,effective_scope,created_by,created_at,superseded_at,superseded_by_change_id,superseded_by_planning_mentor_change_id,superseded_by_teaching_mentor_change_id,superseded_by_admin_planning_mentor_change_id"),
...
const TRANSFORM_COLUMNS = new Set([
  ...
  "person_responsibility_command.idempotency_key", "person_profile_change.idempotency_key", "teacher_profile_identity_change.idempotency_key", "person_relationship_change.idempotency_key", "admin_planning_mentor_relationship_change.idempotency_key", "planning_mentor_relationship_change.idempotency_key", "teaching_mentor_relationship_change.idempotency_key",
