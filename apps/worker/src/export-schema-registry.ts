...
// This is intentionally a fixed allow-list generated from migrations 0001–0041.
...
const TABLE_COLUMNS: Readonly<Record<string, readonly string[]>> = {
  ...
  campus_region_assignment: columns("id,campus_id,region_id,valid_from,valid_to,created_by,created_at,superseded_by_campus_region_change_id,campus_region_change_id"),
  ...
  person_campus_assignment: columns("id,person_id,campus_id,region_id,valid_from,valid_to,created_by,created_at,superseded_by_person_campus_change_id,campus_region_change_id,superseded_by_campus_region_change_id"),
  campus_region_assignment_change_preview: columns("id,campus_id,source_region_id,target_region_id,source_assignment_id,effective_from,effective_to,reason,base_hash,impact_json,actor_role_assignment_id,created_by_person_id,actor_subject_code,actor_scope_type,created_at"),
  campus_region_assignment_change: columns("id,preview_id,campus_id,source_region_id,target_region_id,source_assignment_id,result_assignment_id,continuation_assignment_id,assignment_version,effective_from,effective_to,reason,idempotency_key,request_hash,base_hash,posting_status,settlement_calculation_run_id,ledger_event_id,considered_person_count,affected_assignment_count,considered_fee_count,changed_fee_count,excluded_refund_count,before_json,after_json,published_by_person_id,actor_subject_code,actor_scope_type,published_at,created_at"),
  campus_region_assignment_person_effect: columns("change_id,person_id,source_assignment_id,result_assignment_id,continuation_assignment_id,effective_from,effective_to,before_json,after_json,created_at"),
  campus_region_assignment_settlement_effect: columns("change_id,weekly_fee_entry_id,source_weekly_fee_version,teaching_week_id,settlement_month,previous_snapshot_id,result_snapshot_id,settlement_calculation_run_id,delta_json,created_at"),
  ...
  person_relationship: columns("id,teacher_id,relationship_type,related_person_id,valid_from,valid_to,effective_scope,created_by,created_at,superseded_at,superseded_by_change_id,superseded_by_planning_mentor_change_id,superseded_by_teaching_mentor_change_id,superseded_by_admin_planning_mentor_change_id,person_campus_change_id"),
  person_campus_assignment_change_preview: columns("id,action,person_id,source_assignment_id,result_assignment_id,continuation_assignment_id,source_campus_principal_relationship_id,result_campus_principal_relationship_id,continuation_campus_principal_relationship_id,target_campus_id,target_region_id,target_principal_person_id,target_principal_role_assignment_id,effective_from,effective_to,reason,base_hash,impact_json,actor_role_assignment_id,created_by_person_id,actor_subject_code,actor_scope_type,created_at"),
  person_campus_assignment_change: columns("id,preview_id,action,person_id,assignment_version,source_assignment_id,result_assignment_id,continuation_assignment_id,source_campus_principal_relationship_id,result_campus_principal_relationship_id,continuation_campus_principal_relationship_id,target_campus_id,target_region_id,target_principal_person_id,target_principal_role_assignment_id,effective_from,effective_to,reason,idempotency_key,request_hash,base_hash,posting_status,settlement_calculation_run_id,ledger_event_id,considered_fee_count,changed_fee_count,excluded_refund_count,before_json,after_json,published_by_person_id,actor_subject_code,actor_scope_type,published_at,created_at"),
  person_campus_assignment_change_effect: columns("change_id,weekly_fee_entry_id,source_weekly_fee_version,teaching_week_id,settlement_month,previous_snapshot_id,result_snapshot_id,settlement_calculation_run_id,delta_json,created_at"),
  admin_planning_mentor_relationship_change: columns("id,preview_id,action,mentor_person_id,planner_person_id,relationship_version,source_relationship_id,result_relationship_id,continuation_relationship_id,actor_role_assignment_id,effective_teaching_week_id,effective_through_teaching_week_id,effective_at,next_boundary_at,reason,idempotency_key,request_hash,base_hash,posting_status,settlement_calculation_run_id,ledger_event_id,considered_fee_count,changed_fee_count,excluded_refund_count,planner_delta_cents,source_mentor_delta_cents,destination_mentor_delta_cents,before_json,after_json,published_by_person_id,actor_subject_code,actor_scope_type,published_at,created_at"),
  admin_planning_mentor_relationship_change_effect: columns("change_id,weekly_fee_entry_id,source_weekly_fee_version,teaching_week_id,settlement_month,previous_snapshot_id,result_snapshot_id,settlement_calculation_run_id,planner_account_id,source_mentor_account_id,destination_mentor_account_id,planner_before_cents,planner_after_cents,mentor_before_cents,mentor_after_cents,planner_delta_cents,source_mentor_delta_cents,destination_mentor_delta_cents,delta_json,created_at"),
  admin_planning_mentor_relationship_change_preview: columns("id,action,mentor_person_id,planner_person_id,source_relationship_id,result_relationship_id,continuation_relationship_id,actor_role_assignment_id,effective_teaching_week_id,effective_through_teaching_week_id,effective_at,next_boundary_at,reason,base_hash,impact_json,created_by_person_id,actor_subject_code,actor_scope_type,created_at"),
  ...
  teaching_mentor_relationship_change: columns("id,preview_id,action,relationship_type,teacher_person_id,relationship_version,source_relationship_id,result_relationship_id,continuation_relationship_id,source_related_person_id,new_related_person_id,candidate_role_assignment_id,effective_teaching_week_id,effective_through_teaching_week_id,effective_at,next_boundary_at,reason,idempotency_key,request_hash,base_hash,posting_status,settlement_calculation_run_id,ledger_event_id,considered_fee_count,moved_fee_count,excluded_refund_count,moved_amount_cents,before_json,after_json,published_by_person_id,actor_subject_code,actor_scope_type,published_at,created_at"),
  teaching_mentor_relationship_change_effect: columns("change_id,weekly_fee_entry_id,source_weekly_fee_version,teaching_week_id,settlement_month,previous_snapshot_id,result_snapshot_id,settlement_calculation_run_id,teaching_mentor_amount_cents,source_account_id,destination_account_id,created_at"),
  teaching_mentor_relationship_change_preview: columns("id,action,relationship_type,teacher_person_id,source_relationship_id,source_related_person_id,new_related_person_id,candidate_role_assignment_id,effective_teaching_week_id,effective_through_teaching_week_id,effective_at,next_boundary_at,reason,base_hash,impact_json,created_by_person_id,actor_subject_code,actor_scope_type,created_at"),
...
// These are primary keys from migrations 0001–0039. Keeping them alongside the
...
const TABLE_ORDER_KEYS: Readonly<Record<string, readonly string[]>> = {
  ...
  person_campus_assignment: ["id"], person_profile_change: ["id"], teacher_profile_identity_change: ["id"], person_responsibility_command: ["actor_person_id", "idempotency_key"], person_relationship: ["id"], campus_region_assignment_change_preview: ["id"], campus_region_assignment_change: ["id"], campus_region_assignment_person_effect: ["change_id", "source_assignment_id"], campus_region_assignment_settlement_effect: ["change_id", "weekly_fee_entry_id"], person_campus_assignment_change_preview: ["id"], person_campus_assignment_change: ["id"], person_campus_assignment_change_effect: ["change_id", "weekly_fee_entry_id"], person_relationship_change: ["id"], person_relationship_change_effect: ["change_id", "weekly_fee_entry_id"], person_relationship_change_preview: ["id"], admin_planning_mentor_relationship_change: ["id"], admin_planning_mentor_relationship_change_effect: ["change_id", "weekly_fee_entry_id"], admin_planning_mentor_relationship_change_preview: ["id"], planning_mentor_relationship_change: ["id"], planning_mentor_relationship_change_effect: ["change_id", "weekly_fee_entry_id"], planning_mentor_relationship_change_preview: ["id"], teaching_mentor_relationship_change: ["id"], teaching_mentor_relationship_change_effect: ["change_id", "weekly_fee_entry_id"], teaching_mentor_relationship_change_preview: ["id"], project_bonus_transfer: ["finance_document_id"], rate_policy_version: ["id"], referral_acceptance_idempotency: ["actor_person_id", "idempotency_key"],
...
const TRANSFORM_COLUMNS = new Set([
  ...
  "admin_planning_mentor_relationship_change_preview.impact_json", "admin_planning_mentor_relationship_change.before_json", "admin_planning_mentor_relationship_change.after_json", "admin_planning_mentor_relationship_change_effect.delta_json",
  "campus_region_assignment_change_preview.impact_json", "campus_region_assignment_change.before_json", "campus_region_assignment_change.after_json", "campus_region_assignment_person_effect.before_json", "campus_region_assignment_person_effect.after_json", "campus_region_assignment_settlement_effect.delta_json",
  "person_campus_assignment_change_preview.impact_json", "person_campus_assignment_change.before_json", "person_campus_assignment_change.after_json", "person_campus_assignment_change_effect.delta_json",
  ...
  "teaching_mentor_relationship_change_preview.impact_json", "teaching_mentor_relationship_change.before_json", "teaching_mentor_relationship_change.after_json",
  "person_responsibility_command.idempotency_key", "person_profile_change.idempotency_key", "teacher_profile_identity_change.idempotency_key", "person_relationship_change.idempotency_key", "person_campus_assignment_change.idempotency_key", "campus_region_assignment_change.idempotency_key", "admin_planning_mentor_relationship_change.idempotency_key", "planning_mentor_relationship_change.idempotency_key", "teaching_mentor_relationship_change.idempotency_key",
