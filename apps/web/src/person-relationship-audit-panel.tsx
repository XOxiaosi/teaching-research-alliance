...
const repairabilities: readonly ["", ...PersonRelationshipAuditRepairability[]] = ["", "GROUP_LEADER_REGULAR_WEEK_PREVIEW", "READ_ONLY", "REQUIRES_RELATIONSHIP_CORRECTION", "REQUIRES_P27", "REQUIRES_SPECIAL_PERIOD_SCOPE"];
...
const repairLabel: Record<string, string> = { GROUP_LEADER_REGULAR_WEEK_PREVIEW: "可在普通周组长变更办理", READ_ONLY: "仅可查看", REQUIRES_RELATIONSHIP_CORRECTION: "需关系纠正流程", REQUIRES_P27: "需按 P27 处理", REQUIRES_SPECIAL_PERIOD_SCOPE: "需特殊期间范围" };
