...
const indexPlugin = {
  ...
  setup(buildApi) {
    ...
    buildApi.onResolve({ filter: /^\.\/(referral-panel|financial-panel|reimbursement-panel|refund-panel|venue-board-panel|organization-revenue-panel|cash-wage-panel|cash-wage-confirmation-panel|cash-wage-plan-panel|bonus-project-panel|benefit-plan-panel|benefit-confirmation-panel|benefit-panel|group-leader-change-panel|account-access-panel)$/ }, () => ({ path: "panel", namespace: "index-stub" }));
    ...
    buildApi.onLoad({ filter: /^panel$/, namespace: "index-stub" }, () => ({ loader: "js", contents: `const Blank=()=>null; export const ReferralPanel=Blank;export const FinancialPanel=()=>{globalThis.__miniFinancialMounts=(globalThis.__miniFinancialMounts??0)+1;return '我的提现';};export const ReimbursementPanel=Blank;export const RefundPanel=Blank;export const VenueBoardPanel=Blank;export const OrganizationRevenuePanel=Blank;export const CashWagePanel=Blank;export const CashWageConfirmationPanel=Blank;export const CashWagePlanPanel=Blank;export const BonusProjectPanel=Blank;export const BenefitPlanPanel=Blank;export const BenefitConfirmationPanel=Blank;export const BenefitPanel=Blank;export const GroupLeaderChangePanel=Blank;export const AccountAccessPanel=Blank;export const canReadMiniOrganizationRevenue=()=>false;export const canManageMiniAccountAccess=()=>false;` }));
  },
};
