...
const indexPlugin = {
  ...
  setup(buildApi) {
    ...
    buildApi.onResolve({ filter: /^\.\/(referral-panel|financial-panel|reimbursement-panel|refund-panel|venue-board-panel|venue-management-panel|organization-revenue-panel|cash-wage-panel|cash-wage-confirmation-panel|cash-wage-plan-panel|bonus-project-panel|project-bonus-grant-panel|benefit-plan-panel|benefit-confirmation-panel|benefit-panel|group-leader-change-panel|account-access-panel)$/ }, () => ({ path: "panel", namespace: "index-stub" }));
