...
test("人员职责目录与任免接口声明为严格账号访问管理契约", () => {
  assert.deepEqual(
    ...
    [
      ...
      { method: "POST", path: "/v1/admin/people/:personId/business-identity", action: "MANAGE_ACCOUNT_ACCESS", responseVersion: "person-business-identity-change.v1", requiresRoleContext: true },
    ],
  );
});
