...
try {
  ...
  const ids = Object.fromEntries([
    ...
    if (process.env.DEMO_WITH_BENEFITS === "1") {
      ...
      await salary.setBenefitPlan(salaryContext, { ...benefitDraft, amountCents: "8000", reason: "Synthetic benefit execution plan" }, `demo-benefit-plan2-${suffix}`, at);
