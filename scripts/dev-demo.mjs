...
import { createApiServer, PostgresSessionService, PostgresPersonalReadService, PostgresTeachingReadService, PostgresWeeklyFeeService, hashPassword } from "../apps/api/dist/main.js";
...
try {
  ...
  const ids = Object.fromEntries([
    ...
    server = createApiServer({sessions:new PostgresSessionService(pool),personal:new PostgresPersonalReadService(pool),teaching:new PostgresTeachingReadService(pool),weeklyFees:new PostgresWeeklyFeeService(pool),now:()=>at});
